...
export function CountdownCard({ 
  ...
  return (
    <Card className={`relative overflow-hidden transition-smooth hover:shadow-islamic aspect-[2/1] w-full ${(isExpired && !isDurationCalculation) ? 'opacity-60' : ''} ${isNearExpiry ? 'ring-2 ring-accent' : ''}`}>
      {/* Background Image */}
      {backgroundImage && (
        <div 
